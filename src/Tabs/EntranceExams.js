...
//         {renderLabel1()}
//         <Dropdown
//           style={[styles.dropdown, isFocus1 && { borderColor: 'white' }]}
...
//           labelField="label"
//           valueField="value"
//           placeholder={!isFocus1 ? '--Select Education Level--' : '...'}
...
//         {/* {renderLabel2()}
//         <Dropdown
//           style={[styles.dropdown, isFocus2 && { borderColor: 'white'},{marginTop:15}]}
//           placeholderStyle={styles.placeholderStyle}
//           selectedTextStyle={styles.selectedTextStyle}
//           inputSearchStyle={styles.inputSearchStyle}
//           iconStyle={styles.iconStyle}
...
//           labelField="label"
//           valueField="value"
//           placeholder={!isFocus2 ? '--Select Education--' : '...'}
//           searchPlaceholder="Search..."
//           value={value2}
...
//         {renderLabel3()}
//         <Dropdown
//           style={[styles.dropdown, isFocus3 && { borderColor: 'white'},{marginTop:15}]}
//           placeholderStyle={styles.placeholderStyle}
//           selectedTextStyle={styles.selectedTextStyle}
//           inputSearchStyle={styles.inputSearchStyle}
//           iconStyle={styles.iconStyle}
...
//           labelField="label"
//           valueField="value"
//           placeholder={!isFocus3 ? '--Select Board Tpye--' : '...'}
//           searchPlaceholder="Search..."
//           value={value3}
...
//         {renderLabel4()}
//         <Dropdown
//           style={[styles.dropdown, isFocus4 && { borderColor: 'white'},{marginTop:15}]}
//           placeholderStyle={styles.placeholderStyle}
//           selectedTextStyle={styles.selectedTextStyle}
//           inputSearchStyle={styles.inputSearchStyle}
//           iconStyle={styles.iconStyle}
...
//           labelField="label"
//           valueField="value"
//           placeholder={!isFocus4 ? '-- Select Exam Type--' : '...'}
//           searchPlaceholder="Search..."
//           value={value4}
...
//           labelField="label"
//           valueField="value"
//           placeholder="Select Exam Topics"
//           value={selected7}
//           search
//           searchPlaceholder="Search..."
//           onChange={item => {
